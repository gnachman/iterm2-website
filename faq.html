...
<section>
	...
	<p class="answer">
		A: If you hold down modifier keys while making a selection, the behavior changes in various ways: Alt/Option: Mouse reporting will be disabled. If you're using vim and you can't make a selection, try holding down the alt key and see if that fixes it.
...
<section>
	...
	<p class="answer">
		A: Two steps: 1. Create a new profile called "ssh". In the General tab, select the Command: button and enter $$ as the command.
...
<section>
	<h6 class="question">Q: How do I get 256 color mode working in vim?</h6>
	<p class="answer">
