...
A toggle. When enabled, the active window will always be opaque. This is effective only when windows have transparency enabled.
...
#### View > Auto Composer
Replace the shell prompt with a composer on the bottom of the screen. This feature is in beta.
...
#### View > Make Text Bigger/Smaller/Normal Size
Adjusts text size in the current session.
