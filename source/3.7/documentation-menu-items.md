...
subhead: Menu Items
---
{% capture iterm2 %}{% include 3.7/documentation-iterm2-menu.md %}{% endcapture %}
...
{% capture shell %}{% include 3.7/documentation-shell-menu.md %}{% endcapture %}
...
{% capture edit %}{% include 3.7/documentation-edit-menu.md %}{% endcapture %}
...
{% capture view %}{% include 3.7/documentation-view-menu.md %}{% endcapture %}
...
{% capture session %}{% include 3.7/documentation-session-menu.md %}{% endcapture %}
...
{% capture scripts %}{% include 3.7/documentation-scripts-menu.md %}{% endcapture %}
...
{% capture profiles %}{% include 3.7/documentation-profiles-menu.md %}{% endcapture %}
...
{% capture web %}{% include 3.7/documentation-web-menu.md %}{% endcapture %}
...
{% capture window %}{% include 3.7/documentation-window-menu.md %}{% endcapture %}
