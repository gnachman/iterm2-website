...
subhead: Menu Items
---
{% capture iterm2 %}{% include 3.3/documentation-iterm2-menu.md %}{% endcapture %}
...
{% capture shell %}{% include 3.3/documentation-shell-menu.md %}{% endcapture %}
...
{% capture edit %}{% include 3.3/documentation-edit-menu.md %}{% endcapture %}
...
{% capture view %}{% include 3.3/documentation-view-menu.md %}{% endcapture %}
...
{% capture session %}{% include 3.3/documentation-session-menu.md %}{% endcapture %}
...
{% capture scripts %}{% include 3.3/documentation-scripts-menu.md %}{% endcapture %}
...
{% capture profiles %}{% include 3.3/documentation-profiles-menu.md %}{% endcapture %}
...
{% capture toolbelt %}{% include 3.3/documentation-toolbelt-menu.md %}{% endcapture %}
...
{% capture window %}{% include 3.3/documentation-window-menu.md %}{% endcapture %}
