...
if ( ! ($?iterm2_shell_integration_installed)) then
  ...
  if ( $?loginsh) then
    ...
    if ( x"$ITERM_ENABLE_SHELL_INTEGRATION_WITH_TMUX""$TERM" != xscreen ) then
      ...
      alias _iterm2_print_shell_integration_version 'printf "1337;ShellIntegrationVersion=3;shell=tcsh"'
