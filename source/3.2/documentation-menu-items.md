...
subhead: Menu Items
---
{% capture iterm2 %}{% include documentation-iterm2-menu.md %}{% endcapture %}
...
{% capture shell %}{% include documentation-shell-menu.md %}{% endcapture %}
...
{% capture edit %}{% include documentation-edit-menu.md %}{% endcapture %}
...
{% capture view %}{% include documentation-view-menu.md %}{% endcapture %}
...
{% capture session %}{% include documentation-session-menu.md %}{% endcapture %}
...
{% capture scripts %}{% include documentation-scripts-menu.md %}{% endcapture %}
...
{% capture profiles %}{% include documentation-profiles-menu.md %}{% endcapture %}
...
{% capture toolbelt %}{% include documentation-toolbelt-menu.md %}{% endcapture %}
...
{% capture window %}{% include documentation-window-menu.md %}{% endcapture %}
